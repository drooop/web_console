        ...
        <el-col :span="15">
          ...
          <el-row :gutter="10">
            <el-col>
              <!-- Fork Card Start -->
              <el-card class="box-card">
                <el-collapse-item title=" Forklift Controller" name="5">
                  <el-form
                    ref="forkLiftFormRef"
                    :model="forkLiftForm"
                    label-width="80px"
                    ...
                    <el-row :gutter="10">
                      <el-col :span="6">
                        <el-form-item label="位置">
                          <el-input v-model="forkLiftForm.loc"></el-input>
                        </el-form-item>
                      </el-col>
                      <el-col :span="6">
                        <el-form-item label="速度">
                          <el-input v-model="forkLiftForm.speed"></el-input>
                        </el-form-item>
                      </el-col>
                      <el-col :span="6">
                        <el-form-item label="方法">
                          <el-select
                            v-model="forkLiftForm.method"
                            placeholder="请选择"
                          >
                            <el-option
                              v-for="item in forkMethodOptions"
                              :key="item.value"
                              :label="item.label"
                              :value="item.value"
                            ></el-option>
          ...
          <el-row>
            ...
            <el-col>
              <el-card class="box-card">
                <el-collapse-item title=" AGV Controller" name="6">
                  <el-tabs type="card">
                    <el-tab-pane label="按绝对值">
                      <el-form
                        ref="AGVFormRef"
                        :model="AGVForm"
                        size="mini"
                      ...
                      >
                        <el-row :gutter="10">
                          <el-col :span="12">
                            <el-row :gutter="10">
                              <el-col :span="12">
                                <el-form-item label="向量1">
                                  <el-input
                                    v-model="forkLiftForm.loc"
                                  ></el-input>
                                </el-form-item>
                              </el-col>
                              <el-col :span="12">
                                <el-form-item label="向量2">
                                  <el-input
                                    v-model="forkLiftForm.loc"
                                  ></el-input>
                                </el-form-item>
                        ...
                        <el-row :gutter="10">
                          <el-col :span="12">
                            <el-radio v-model="AGVMovingModeRadio" label="1">
                              前进
                            </el-radio>
                            <el-radio v-model="AGVMovingModeRadio" label="2">
                              后退
                            </el-radio>
                          </el-col>
                        </el-row>
